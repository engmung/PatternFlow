...
<figure className="journal-md-figure">
  <img src="/journal/refocus/clean-3d-print.jpg" alt="3D printed body sponsored by PCBway" />
  <figcaption>A test 3D printing result printed in one piece via PCBway sponsorship.</figcaption>
</figure>

<div className="journal-figure-row">
  <figure className="journal-md-figure">
    <img src="/journal/refocus/pcbway-delivery-1.jpg" alt="PCBway package box" />
    <figcaption>The PCBway shipping box delivered safely and quickly.</figcaption>
  </figure>
  <figure className="journal-md-figure">
    <img src="/journal/refocus/pcbway-delivery-2.jpg" alt="Internal package wrapping" />
    <figcaption>Securely packed state with protective air bubble wrap.</figcaption>
  </figure>
</div>
